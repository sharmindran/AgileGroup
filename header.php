    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/LOGO1.jpg" alt="image" width="300"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">kushabobcarrental@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:012-4339840">+0129654309</a> </div>
...
echo "Welcome To Kushabob Car rental portal";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-testimonials.php">My Comment</a></li>
          ...
          <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">My Comment</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="page1.php">About Us</a></li>
          <li><a href="car-listing1.php">Car Listing</a>
          <li><a href="contact-us.php1">Contact Us</a></li>
